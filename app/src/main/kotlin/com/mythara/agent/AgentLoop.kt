                ...
                ChatMessage(
                    ...
                    content =
                        "AUTO-REPLY MODE — you are composing a reply to ${parsed.contact} for the user, on the user's behalf, without asking the user first. They've trusted you with this contact.\n\n" +
                            ...
                            "       a. open_app on ${parsed.app} — this lands you in the messaging app. For WhatsApp specifically, the chat with the new message is almost always at the top of the list. Just call open_app; do not preface with a question.\n" +
